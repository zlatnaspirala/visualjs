...
var mirrorCubeMaterial = new THREE.MeshBasicMaterial( { envMap: ROOT.mirrorCubeCamera.renderTarget } );
...
function BALL_MIRROR (){
 ...
 var ROOT = this;
	...
	var mirrorSphereMaterial = new THREE.MeshBasicMaterial( { envMap: ROOT.mirrorSphereCamera.renderTarget } );
