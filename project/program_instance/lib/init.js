//###############################################//###############################################
//  Whole preload class/procedural function samo class with single instance princip 
//  Initial staff
//###############################################//###############################################
...
function DOM() {
	...
	* @return false - if removing faild.
	*/
...
/** 
* Set Stream 
* @method SET_STREAM will activate webcam , getUserMedia inside.
* @return {boolean} True Means webcam operartion supported.
...
* @method CREATE_MOTION_PARAMETERS  
...
* @object {array} ARRAY_SOUND  
* @access {Global} ARRAY_SOUND
*/
window["ARRAY_SOUND"] = [];
...
* @method validateEmail Global method ,  pseudo
