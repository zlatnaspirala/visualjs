...
socket.on('ADD_NEW_GAME_OBJECT', function(  name , x , y, w, h , PROGRAM_NAME , MODUL ){
	
	    console.log("ADD_NEW_GAME_OBJECT ACTION : " , name );
	   
		mkdirp( CONFIG.PATH_OF_WWW + "/lib/visual_script/" +  name + ""  , function(err) { 
		if (err == null) {	
...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ 
// sifra 2
socket.on('DESTROY_GAME_OBJECT_WITH_DELAY', function(  name , sec , MODUL , PROGRAM_NAME ){
	   ...
	   createFile(  local_path + "/" + "a2.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').DESTROY_AFTER = "+sec+";",  local_pathC , "AFTER_F5");
...
socket.on('SET_NEW_START_UP_POSITION', function(  name , PROGRAM_NAME , MODUL , newX , newY , w , h){
	   ...
	   createFile(  local_path + "/" + "a2.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').NEW_OBJECT('" + name + "'," + newX + " , " + newY + "," + w + ","  + h + ");",  local_pathC , "AFTER_F5");
...
socket.on('ADD_ANIMATION', function(  name , PROGRAM_NAME , MODUL , RES ){
	   ...
	   var ID = random (100000,9999999) + random (100000,9999999)+ random (100000,9999999);
	   ID = ID.toString().replace(".","11");
	   ID = parseInt(ID);
	   createFile(  local_path + "/" + "a3.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_ANIMATION( SURF , 'LOOP' , 1 , RESOURCE."+RES+" , "+ID+" , 'no' , 1,11,1,1,1);",  local_pathC , "LOAD_NOW");
...
socket.on('ADD_COLLISION', function(  name , PROGRAM_NAME , MODUL , margin ){
	   ...
	   createFile(  local_path + "/" + "a4.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_COLLISION( 'BLOCK' , "+margin+"  );",  local_pathC , "LOAD_NOW");
...
socket.on('REMOVE_COLLISION', function(  name , PROGRAM_NAME , MODUL  ){
	   ...
	   var local_pathC = CONFIG.PATH_OF_WWW + "/lib/visual_script/" +  name + "/a4.js";   
...
socket.on('ATACH_PLAYER', function(  name , PROGRAM_NAME , MODUL , type__ , index_){
	   ...
	   createFile(  local_path + "/" + "a5.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_PLAYER('"+type__+"');   " + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').EDITOR.BUTTONS["+index_+"].text = 'Deatach player'; ",  local_pathC , "LOAD_NOW");
...
socket.on('DEATACH_PLAYER', function(  name , PROGRAM_NAME , MODUL  ){
	   ...
	   var local_pathC = CONFIG.PATH_OF_WWW + "/lib/visual_script/" +  name + "/a5.js";   
       deleteFile (local_pathC);
...
socket.on('ADD_PARTICLE', function(  name , PROGRAM_NAME , MODUL , type__ ){
	   ...
	   createFile(  local_path + "/" + "a6.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_PARTICLE('"+type__+"');",  local_pathC , "LOAD_NOW");
...
socket.on('REMOVE_PARTICLE', function(  name , PROGRAM_NAME , MODUL  ){
	   ...
	   var local_pathC = CONFIG.PATH_OF_WWW + "/lib/visual_script/" +  name + "/a6.js";   
       deleteFile (local_pathC);
...
socket.on('ADD_TEXTBOX', function(  name , PROGRAM_NAME , MODUL , text , radius , color , textcolor){
	   ...
	   createFile(  local_path + "/" + "a7.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_TEXTBOX('"+text+"' , '"+radius+"' , '"+color+"' , '"+textcolor+"');",  local_pathC , "LOAD_AFTER_F5");
...
socket.on('REMOVE_TEXTBOX', function(  name , PROGRAM_NAME , MODUL  ){
	   ...
	   var local_pathC = CONFIG.PATH_OF_WWW + "/lib/visual_script/" +  name + "/a7.js";   
       deleteFile (local_pathC);
...
socket.on('ADD_WEBCAM', function(  name , PROGRAM_NAME , MODUL , type_ , type_of_dim , byV , byH){
	//	LOCAL_COMMUNICATOR.emit('ADD_WEBCAM',  name , PROGRAM_NAME , MODUL , type_ , type_of_dim , byV , byH);
	   ...
	   createFile(  local_path + "/" + "a8.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_WEBCAM('" + type_ + "','" + type_of_dim + "');",  local_pathC , "LOAD_NOW");
		   
	   }
	   else {// is NUI
		   
	   createFile(  local_path + "/" + "a8.js" , "" + PROGRAM_NAME + ".ENGINE.MODULES.ACCESS_MODULE( '" +  MODUL + "').GAME_OBJECTS.ACCESS('" + name + "').CREATE_WEBCAM('" + type_ + "','" + type_of_dim + "' , '" + byV + "','" + byH + "');",  local_pathC , "LOAD_NOW");
...
console.log(LIST_OFF_ALL_GAME_OBJECT , "<<LIST_OFF_ALL_GAME_OBJECT")	 
 var local__x = 0;
				...
				GET_FILES_NAME(CONFIG.PATH_OF_WWW + "/lib/visual_script/" + val , val , true );
  
				}else {			
				//console.log("NIJE POSLEDNJI");
				GET_FILES_NAME(CONFIG.PATH_OF_WWW + "/lib/visual_script/" + val , val , false );
...
function GET_FILES_NAME(path , name_of_go , main_length ){
   fs.readdir(path, function(err, items) {
    ...
    io.sockets.emit('RETURN', "LOAD_SCRIPT" ,   "lib/visual_script/" + name_of_go + "/" +  items[i]   );
