...
var materialFront = new THREE.MeshBasicMaterial( { color: 0x0ff0a0 } );
...
// add a wireframe to model
 var wireframeTexture = new THREE.MeshBasicMaterial( { color: 0xff2002, wireframe: true, transparent: true } ); 
