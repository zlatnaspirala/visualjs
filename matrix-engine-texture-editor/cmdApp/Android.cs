...
namespace CmdWindowControlTestApp {
    ...
    public partial class Android : Form {
        ...
        /// <summary>
        /// Handles the FormClosing event of the Android control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.Windows.Forms.FormClosingEventArgs"/> instance containing the event data.</param>
        private void Android_FormClosing(object sender, FormClosingEventArgs e) {
        ...
        private void rtb_StderrTextRead(string text) {
            ...
            //Console.WriteLine("Android.EOnStderrTextRead- text=" + text);
        }
