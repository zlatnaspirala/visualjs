...
function CANVAS2d_SURFACE_TEXTURE(path_, path_to_run_script) {
    ...
    ROOT.iframe.setAttribute('width', '512px');
    ROOT.iframe.setAttribute('height', '512px');
    ...
    document.getElementById(ROOT.iframe.id).onload = function() {
        ...
        App.scene.outsideBox.streamTextures.iframe.contentWindow.SYS.SCRIPT.LOAD(path_to_run_script)
