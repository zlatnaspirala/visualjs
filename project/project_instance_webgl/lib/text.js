			...
			ROOT.mirror = false;
			   ...
			   ROOT.material = new THREE.MultiMaterial( [
				...
				ROOT.DESTROY = function(textSettings_){
					...
					if ( textSettings_.mirror ){ group.remove( textSettings_.textMesh2 );}
	 ...
	 function createText(textSettings_) {
				...
				textSettings_.pointLight.position.set( 122 , 80 , 80);
					 ...
					 if (typeof helper != 'undefined') {
							...
							textSettings_.pointLight.add( new THREE.Mesh( sphere, new THREE.MeshBasicMaterial( { color: 0x00ff40 } ) ) );
