...
/* for HTTP-only
httpProtocol = require('http').createServer(function (request, response) {
...
httpProtocol = require('https').createServer(options, function(request, response) {
  request.addListener('end', function() {
    if(request.url.search(/.png|.gif|.js|.css/g) == -1) {
      file.serveFile('/index.html', 402, {}, request, response);
    } else file.serve(request, response);
