...
THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = textureLoader.load("res/textures/particle/perlin-512.png");
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = textureLoader.load("res/textures/particle/particle2.png");
