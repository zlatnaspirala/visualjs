...
LOGIN_MODULE.NEW_OBJECT("ROOM_LIST_OBJECT" , 40 , 44 , 20 , 10 , 10);
ROOM_LIST_OBJECT.CREATE_TEXTBOX("data from server " , 10 , "black" , "#AEE7FF");
ROOM_LIST_OBJECT.TEXTBOX.BACKGROUND_OPACITY = 0.75;
ROOM_LIST_OBJECT.TEXTBOX.font = '21px Arial';

ROOM_LIST_OBJECT.TYPE_OF_GAME_OBJECT = 'NO_RENDER';
//ROOM_LIST_OBJECT.VISIBLE = false;  
...
ACCOUNT_SYSTEM.ON_SESSION_TAKE = function(){
 ...
 SYS.DEBUG.NETWORK_LOG('SESSION OPENED');
 window[LOGIN_MODULE.PARENT].ENGINE.KEYBOARD.TARGET = undefined;
 //Background_Login_Form
 LOGIN_MODULE.DESTROY_OBJECT("Background_Login_Form");
 LOGIN_MODULE.DESTROY_OBJECT("BTN_REGISTER_Login_Form");
 LOGIN_MODULE.DESTROY_OBJECT("Password_Login_Form");
 LOGIN_MODULE.DESTROY_OBJECT("Email_Login_Form");
 LOGIN_MODULE.DESTROY_OBJECT("BTN_LOGIN_Login_Form");
 ROOM_LIST_OBJECT.TYPE_OF_GAME_OBJECT = 'TEXT_BOX';
